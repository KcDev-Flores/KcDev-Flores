...
<a target="_blank" align="center">
  <video autoplay loop muted playsinline align="right" height="300" width="400" src="kali_logo_transparente.webm"></video>
</a>

- 🔭 Actualmente trabajo en proyectos de **Backend**.

- 🌱 Profundizando mis conocimientos en **Ciberseguridad y desarrollo web**.

- 🤝 Estoy abierto a colaboraciones y proyectos interesantes.

- ⚡ Intereses técnicos: **Kali Linux, Nmap, Wireshark, C++, React y Bases de Datos**.
...
<p align="center">
  <div align="center" class="icons-social" style="margin-left: 10px;">
        <a style="margin-left: 10px;" target="_blank" href="https://github.com/KcDev-Flores">
